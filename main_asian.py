...
def main(config_path):
    ...
    from trainers.asian_trainer import AsianTrainer

    # from trainers.centerloss_trainer import FER2013Trainer
    trainer = AsianTrainer(model, train_set, val_set, test_set, configs)
