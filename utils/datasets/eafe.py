...
class EAFE(Dataset):
    def __init__(self, stage, configs, tta=False, tta_size=48):
        ...
        self._data = pd.read_csv(
            os.path.join(configs["data_path"], "eafe/{}.csv".format(stage))
        )
    ...
    def __getitem__(self, idx):
        ...
        image = np.asarray(pixels).reshape(224, 224)
...
def eafe2022(stage, configs=None, tta=False, tta_size=48):
    return EAFE(stage, configs, tta, tta_size)
